...
math_symbols_path = './datasets/math_symbols'
AZ_data = pd.read_csv(az_data_path +'/A_Z Handwritten Data.csv',header = None)
math_symbols_train = pd.read_csv(math_symbols_path +'/train/_classes.csv',header = None)
math_symbols_test = pd.read_csv(math_symbols_path +'/valid/_classes.csv',header = None)
...
history = model.fit(
      ...
      validation_steps=50,
      verbose=2)
model.save('model_mnist_numbers')
